...
def num_of_model():
    ...
    found = False
    while (not found):
        filepath = '../temperature_prediction_models/prediction_model_'+str(i)
        try:
...
class TemperaturePredictionModel:
    ...
    def train(self):
        ...
        if (decision == "y" or decision == "Y"):
            save_path = '../temperature_prediction_models/prediction_model_'+str(num_of_model()+1)+'.h5'
    ...
    def predict(self, inputs, delta_time, time):
        ...
        return prediction.item() + package[1]['temp']
...
def create_model():
    return TemperaturePredictionModel(**parameters)
